...
const collectibles = {
  ...
  listFigures: function () {
    unifiedCollectibles.forEach((collectable) => console.log(collectable));
  },
  // Desafio 2 - 5.b
  figuresByBrand: function (brand) {
    return unifiedCollectibles.filter(
      (collectable) =>
        collectable.marca.trim().toUpperCase() == brand.trim().toUpperCase()
    );
  },
};
